...
class Wallet extends Component {
  ...
  _addCash(){
      fetch("http://efund.alliedco.pk:5000/api/wallet/add-cash",{
    method:"POST",
      headers: {
...
_getTransaction(){
  fetch("http://efund.alliedco.pk:5000/api/wallet/transaction",{
method:"GET",
  headers: {
    'Accept': 'application/json',
   'Content-Type': 'application/json',
...
_getCash(){
  fetch("http://efund.alliedco.pk:5000/api/wallet/get-amount",{
method:"GET",
  headers: {
    'Accept': 'application/json',
   'Content-Type': 'application/json',
